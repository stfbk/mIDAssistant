...
public class InsertCodeHandler {
    ...
    {
        String btn_name = GenerateClassAuthentication.getInstance().getBtnName();
    ...
    public void invoke(@NotNull final Project project)
    {
        ...
        new WriteCommandAction(project, new PsiFile[0])
        {
            protected void run(@NotNull Result result)
                    throws Throwable
            {
                Pair<PsiElement, PsiElement> psiElementPair = InsertCodeUtils.maybeAddStatementsToMethod(InsertCodeHandler.list2, InsertCodeHandler.this.myActivityOnCreateMethod, project);
                if (psiElementPair == null) {
                    return;
                }
                InsertCodeUtils.maybeInsertImportList(InsertCodeHandler.IMPORT_CLASSES_LIST, InsertCodeHandler.this.myActivity, project);
                ...
                CodeStyleManager.getInstance(project).reformat(InsertCodeHandler.this.myActivityOnCreateMethod);
