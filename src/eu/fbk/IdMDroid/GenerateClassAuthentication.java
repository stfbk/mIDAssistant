...
public class GenerateClassAuthentication {
    private String idmName;
    private static GenerateClassAuthentication INSTANCE;
    private GenerateClassAuthentication(){
        idmName = "test";
    }
    public static GenerateClassAuthentication getInstance () {
        if (INSTANCE == null){
            INSTANCE = new GenerateClassAuthentication();
        }
        return INSTANCE;
    }
